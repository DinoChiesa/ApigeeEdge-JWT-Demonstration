...
## Using id tokens from Google signin

To get an ID Token from Google, you can use [this example signin page](https://dinochiesa.github.io/openid-connect/goog-login.html).
Use the form to build the link.  Click the link to kickoff the google signin procedure. When it completes you will see a JWT. You can copy/paste that into a command to verify that token , like this:
